          ...
          <div class="brand-cta-row">
            ...
            <?php
              while ( have_rows('edp_brand_deals') ) : the_row();?>
                <a href="tel:<?php echo the_sub_field('edp_brand_deal_phone');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall');">
                  <div class="brand-cta" >
                    <div class="inner">
                      ...
                      <h5>
                        <a href="tel:<?php echo the_sub_field('edp_brand_deal_phone');?>"  style="color: #ff6600;" onClick="ga('send', 'event', 'Call', 'ClicktoCall');"><?php echo the_sub_field('edp_brand_deal_phone');?></a>
                      </h5>
                    </div>
                  </div>
                </a>
          ...
          <span class="phone-no">
            <!-- dynamic phone number via url params -->
                ...
                if(get_field('edp_brand_phone')){ ?>
                    <a href="tel:<?php echo get_field('edp_brand_phone');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall');" class="phone-number">
                    <?php
