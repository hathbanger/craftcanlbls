                ...
                <div class="inner">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <?php } elseif ( $icon_selector == 'Internet' ) { ?>
                                <div class="internet"></div>
                            <?php } elseif ( $icon_selector == 'Phone' ) { ?>
                                <div class="phone"></div>
                            <?php } elseif ($icon_selector == 'Security' ) { ?>
                                <div class="security"></div>        
                            <?php } elseif ($icon_selector == 'Tech' ) { ?>
                                <div class="tech"></div>        
                            <?php } elseif ($icon_selector == 'Solar' ) { ?>
                                <div class="solar"></div>        
                            <?php } elseif ($icon_selector == 'Wellness' ) { ?>
                                <div class="wellness"></div>          
                            <?php } elseif ($icon_selector == 'Double Play' ) { ?>
                                <div class="dblPlay"></div>          
                            <?php } elseif ($icon_selector == 'Triple Play' ) { ?>
                                <div class="tplPlay"></div>        
                            <?php } ?>
                        </div>
                    </div>
                    <!-- /.row -->
