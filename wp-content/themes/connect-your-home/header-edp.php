...
@font-face {
  ...
  src: url("../fonts/gotham-book.eot?#iefix") format("embedded-opentype"), url("../fonts/gotham-book.woff") format("woff"), url("../fonts/gotham-book.ttf") format("truetype"), url("../fonts/gotham-book.svg#gotham_bookregular") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
@font-face {
  ...
  src: url("../fonts/gotham-bookitalic.eot?#iefix") format("embedded-opentype"), url("../fonts/gotham-bookitalic.woff") format("woff"), url("../fonts/gotham-bookitalic.ttf") format("truetype"), url("../fonts/gotham-bookitalic.svg#gotham_bookitalic") format("svg");
  font-weight: normal;
  font-style: normal;
}
...
.package-row > .packages {
  ...
  width: 33%;
  margin-right: 4px;
  border-bottom: 4px solid #6cb43f;
...
<!-- dynamic phone number via url params -->                <?php
                if(get_field('edp_brand_phone')){ ?>
                    <a href="tel:<?php echo get_field('edp_brand_phone');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall');" class="phone-number edp-number">
                    <?php
                        echo get_field('edp_brand_phone');
                }elseif(get_field('phone_number_one_brand')){ ?><a href="tel:<?php echo get_field('phone_number_one_brand');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall');" class="phone-number edp-number">
                <?php
                        echo get_field('phone_number_one_brand');
                }else{ ?><a href="tel:<?php echo get_field('home_phone_number', 'option');?>" onClick="ga('send', 'event', 'Call', 'ClicktoCall');" class="phone-number edp-number">
                <?php
