...
if ( ! class_exists( 'Brewery_Customizer_Library_Styles' ) ) :
/**
 ...
 */
class Brewery_Customizer_Library_Styles {
...
if ( ! function_exists( 'brewery_customizer_library_styles' ) ) :
/**
 ...
 */
function brewery_customizer_library_styles() {
	return Brewery_Customizer_Library_Styles::instance();
}
endif;

add_action( 'init', 'brewery_customizer_library_styles', 1 );