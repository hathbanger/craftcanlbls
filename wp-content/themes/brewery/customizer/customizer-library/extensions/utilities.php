...
function brewery_customizer_library_get_default( $setting ) {
 ...
 * @return mixed $default
 */
function brewery_customizer_library_get_choices( $setting ) {
 ...
 * @return array
 */
function brewery_customizer_library_hex_to_rgb( $hex ) {
 ...
 * @return mixed $default
 */
function brewery_customizer_library_remove_theme_mods() {
