...
if ( ! class_exists( 'SLPlus_Location' ) ) {
	...
	class SLPlus_Location {
		...
		public function delete( $id = null ) {
			...
			//
			if ( (int) $this->id < 0 ) {
				return new WP_Error( 'slp_invalid_id', $this->slplus->text_manager->get_text_string( array(
					'label',
					'slp_invalid_id'
				) ), array( 'status' => 404 ) );
			}
		...
		public function get_location( $location_id ) {
			...
			if ( is_null( $this->locationData ) ) {
				$result = new WP_Error( 'slp_no_such_location', $this->slplus->text_manager->get_text_string( array(
					'error',
				...
				$result = new WP_Error( 'slp_get_location_failed', $this->slplus->text_manager->get_text_string( array(
					'label',
